...
using namespace std;
int  inputjumlahdata,jumlahbarang[100], hargabarang[100], totaldata = 0, pilihmenupencarian,  carihargabarang;
...
void searchingdata(){
    ...
    if (cin.fail()|| pilihmenupencarian < 0 || pilihmenupencarian > 3) {
